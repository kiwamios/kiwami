-- Git: signs in the gutter with hunk operations, and diffview for the
...
require('gitsigns').setup {
  ...
  on_attach = function(bufnr)
    ...
    -- ]c and [c already mean something in a diff, so defer to vim there.
    map('n', ']c', function()
      if vim.wo.diff then
...
vim.keymap.set('n', '<leader>gD', '<cmd>DiffviewOpen origin/HEAD...HEAD<CR>', { desc = '[G]it [D]iff vs branch base' })
